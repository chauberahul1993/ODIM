...
func Router() *iris.Application {
	...
	pc := handle.AggregatorRPCs{
		...
		GetResetActionInfoRPC:                   rpc.DoRestActionInfoService,
	}
	...
	aggregation.Get("/", pc.GetResetActionInfoService)
	aggregation.Get("/ResetActionInfo", pc.GetResetActionInfoService)
	aggregation.Get("/SetDefaultBootOrderActionInfo", pc.GetAggregationService)
