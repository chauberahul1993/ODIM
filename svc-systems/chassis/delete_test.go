...
func Test_findAllPlugins(t *testing.T) {
	...
	err := mockAddManagertoDB("Managers", "/redfish/v1/Managers/ba06875a-a292-445d-89ef-90e984e806ed.1", managerData, persistencemgr.InMemory)
	if err != nil {
	...
	err = mockAddPlugonToDB("Plugin", "ILO_v1.0.0", pluginData, persistencemgr.OnDisk)
	if err != nil {
	...
	err = mockAddManagertoDB("Managers", "/redfish/v1/Managers/3ccb5c71-0e00-4d14-93bb-8d125c030f27", managerDetails, persistencemgr.InMemory)
	if err != nil {
		t.Fatalf("Error in creating mock Manager :%v", err)
	}
	defer func() {
	...
	err = mockAddManagertoDB("Chassis", "/redfish/v1/Managers/ba06875a-a292-445d-89ef-90e984e806ed.1", addChasis, persistencemgr.InMemory)
	if err != nil {
		t.Fatalf("Error in creating mock Manager :%v", err)
	}
