...
Set "User:admin"  '{"UserName":"admin","Password":"x7DW_WuAFAnKxUOgKXe_gtGFo2ILo21y-3Do2eBP9EYLDgScGQ8fJSyoxvByY9SWjVOjzcG-OHpeAelVKNzn8A==","RoleId":"Administrator", "AccountTypes":["Redfish"]}'
